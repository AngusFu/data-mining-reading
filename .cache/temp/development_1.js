var createApp = (function () {
  ...
  var vueMeta = createCommonjsModule(function (module, exports) {
  /**
   * vue-meta v1.5.2
  ...
  */
  ...
  var vueRouter_esm = /*#__PURE__*/Object.freeze({
    default: VueRouter
  });
  ...
  var Vue$2 = ( vue_runtime_esm && Vue$1 ) || vue_runtime_esm;

  var VueRouter$1 = ( vueRouter_esm && VueRouter ) || vueRouter_esm;

  Object.assign = assign_1;

  Vue$2.use(vueMeta);
  Vue$2.use(VueRouter$1);
  ...
  const jsonpCache = {};
  createApp.use = plugin => Vue$2.use(plugin);
  createApp.jsonp = function (id) {
    if (jsonpCache[id]) {
      return Promise.resolve(jsonpCache[id])
    }

    const nprogress = Vue$2.prototype.$nprogress;
  ...
  function createApp (option) {
    ...
    if (plugins) {
  [].concat(plugins).map(plugin => Vue$2.use(plugin));
    }
    ...
    assign_1(cachedOption, { app, router });
    return { app, router }
  }
  ...
  function handleSSEMessage ({ data }) {
    ...
    if (type === 'prototype') {
      ...
      Vue$2.prototype[key] = value;
      Vue$2.set(Vue$2.prototype, key, value);
